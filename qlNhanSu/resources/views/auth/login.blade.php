    ...
    <div class="row" style="display: flex; background-color: #457B9D">
        ...
        border-bottom-left-radius: 70px;">
            ...
            <form method="POST" action="{{ route('login') }}" style="width: 100%; margin-top: 10%;">
                ...
                <label class="fst-italic" style="color: red; font-size: 14px">(*) Đăng nhập bằng tài khoản("2151170000"/ "2151179999")/mật khẩu("12345678") của <span class="fst-italic fw-bold" style="color: red; font-size: 13px">trang khai báo thông tin</span></label>
